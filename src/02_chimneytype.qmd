...
makeChimneytype = function({
  ...
  const labelExprString = `datum.label === 'Arme' ? '${quantileLabels["Arme"] || "Arme"}' : datum.label === 'Untere Mittelschicht' ? '${quantileLabels["Untere Mittelschicht"] || "Untere Mittelschicht"}' : datum.label === 'Mittelschicht' ? '${quantileLabels["Mittelschicht"] || "Mittelschicht"}' : datum.label === 'Obere Mittelschicht' ? '${quantileLabels["Obere Mittelschicht"] || "Obere Mittelschicht"}' : datum.label === 'Reiche' ? '${quantileLabels["Reiche"] || "Reiche"}' : datum.label`;
    ...
    width < 860 ? { 
      row: { 
        ...
        header: showHeader ? { 
          ...
          labelAlign: "left", 
          labelAnchor: "start",
          labelExpr: labelExprString  // USE THE VARIABLE
        } : { 
          labels: false
        } 
      }, 
