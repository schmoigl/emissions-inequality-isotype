...
width >= 860 ?
  html`<div style="display: flex; justify-content: center; align-items: center; gap: 30px; font-family: Jost; font-size: 15px; padding-top: 12px; padding-bottom: 0px;">
    <div style="display: flex; align-items: flex-end; gap: 4px;">
      ...
      <span style="font-weight: 400;">${t("legend_500")}</span>
    </div>
    <div style="display: flex; align-items: flex-end; gap: 4px;">
      ...
      <span style="font-weight: 400;">${t("legend_250")}</span>
    </div>
  </div>`
  :
...
//| echo: false
{
  ...
  return html`<div style="display: flex; justify-content: center; background-color: transparent; padding: 0px;">
    ${viz}
  </div>`;
}
```
